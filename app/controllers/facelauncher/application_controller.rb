module Facelauncher
  class ApplicationController < ActionController::Base
    ...
    def index_base
      ...
      facebook_app_secret = ENV.key?('FACEBOOK_APP_SECRET') ? ENV['FACEBOOK_APP_SECRET'] : @program.program_app.facebook_app_secret
    ...
    def get_program
      begin
        @program = Facelauncher::Program.find(Facelauncher::Engine.config.program_id)
...
#        @video_playlists = Facelauncher::VideoPlaylist.all(true)
